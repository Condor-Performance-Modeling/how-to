...
Fusions are defined in the `llvm/lib/Target/RISCV/RISCVMacroFusion.td` file. To add new fusion predicator, edit this file and add a new pair followin below syntax (example) - **TODO**.
...
To enable the macro fusion feature for a specific processor, you need to update the processor model in the `RISCVProcessors.td` file to include the new fusion feature.
